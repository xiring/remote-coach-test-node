export const YEAR_MONTH_MAX_DATE = {
...
// const sum = Object.values(YEAR_MONTH_MAX_DATE).reduce((previousValue, currentValue) => {
//   return previousValue + currentValue.reduce((prev, current) => {
//     return prev + current;
//   }, 0);
// }, 0);
